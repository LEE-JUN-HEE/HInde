...
public class Common
{
    ...
    static public float Up_Pos_y = 40;
    static public float Down_Pos_y = -40;
    ...
    static public string Sprite_Build = "St1_ba_d_cone1";
    static public string Sprite_Booster = "Item_booster";
    static public string Sprite_Fly = "Fly";
    static public string Sprite_Column = "St1_ba_d_gidoong";
